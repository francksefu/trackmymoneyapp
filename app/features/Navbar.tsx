...
const NavItem = ({items}: {items: Menu}) => {
    return(
        <li>
            <a href="#" className="block py-2 px-3 text-white bg-blue-700 rounded-sm md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500 dark:bg-blue-600 md:dark:bg-transparent" aria-current="page">{items.title}</a>
        </li>
    );
}

const NavItemDropdown = ({items}:{items:({title: string, contents: Menu[], expendedMenu: Menu|null})}) => {
    return(
        <li>
